...
public class Athlete implements Participant, Medaille{
     ...
     */
    public Athlete(String nom, String prenom, String sexe, double force, double agilite, double endurance,Equipe equipe  ,Pays pays, int id) throws MauvaiseEquipeException, PasUnSexeException{
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        if(sexe.equals("M") || sexe.equals("F")){this.sexe = sexe;}
     ...
     * @param id l'id d'un athlete
     */
    public Athlete(String nom, String prenom, String sexe, double force, double agilite, double endurance,Pays pays, int id) throws PasUnSexeException{
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        if(sexe.equals("M") || sexe.equals("F")){this.sexe = sexe;}
    ...
    /**
     * @return l'équipe de l'athlete s'il en a une.
     */
    ...
    public void ajouteEpreuve(Epreuve uneEpreuve){
        ...
        uneEpreuve.ajouteUnAthlete(this);
    }
