...
public class ExecutableOlympique {
    public static void main(String[] args) throws PasUnSexeException, PaysDejaDansJOException {
        ...
        Epreuve brasseM = new Epreuve("100m brasse hommes", brasseNatation, "M", 4.1, 1.9, 1.5);
        Epreuve brasseF = new Epreuve("100m brasse femmes", brasseNatation, "F",  4.1, 1.9, 1.5);
        ...
        Epreuve relaisF = new Epreuve("4x100m nage libre relais femmes", nageLibreNatation, "F", 2.2, 2.2, 3.1); 
        Epreuve relaisM = new Epreuve("4x100m nage libre relais hommes", nageLibreNatation, "M", 2.2, 2.2, 3.1);
        
        //Handball : femmes / hommes Force: 3; Agilité 2.5; Endurance 2
        Handball handball  = new Handball("Handball", 7);
        
        Epreuve handballF = new Epreuve("Handball feminin", handball, "F", 3, 2.5, 2) ;
        Epreuve handballM = new Epreuve("Handball masculin", handball, "M", 3, 2.5, 2) ;
    
        //Volley-ball : femmes / hommes Force: 3.5; Agilité 1.5; Endurance 2.5
        VolleyBall volleyball = new VolleyBall("Volley Ball", 6);

        Epreuve volleyballM = new Epreuve("Volley-ball masculin", volleyball, "M", 3.5, 1.5, 2.5);
        Epreuve volleyballF = new Epreuve("Volley-ball feminin", volleyball, "F", 3.5, 1.5, 2.5);

        //Escrime : fleuret femmes / hommes Force: 1.5; Agilité 3.5; Endurance 2.5
        Escrime escrimeF = new Escrime("Escrime fleuret", "Fleuret"); 

        Epreuve escrimeFM = new Epreuve("Escrime fleuret masculin", escrimeF, "M", 1.5, 3.5, 2.5);
        Epreuve escrimeFF = new Epreuve("Escrime fleuret féminin", escrimeF, "F", 1.5, 3.5, 2.5);

        //Escrime : épée femmes / hommes Force: 1.6; Agilité 3.4; Endurance 2.5
        Escrime escrimeE = new Escrime("Escrime Epee", "Epée");

        Epreuve escrimeEM = new Epreuve("Escrime epée masculin", escrimeE, "M", 1.6, 3.4, 2.5);
        Epreuve escrimeEF = new Epreuve("Escrime epée féminin", escrimeE, "F", 1.6, 3.4, 2.5);
        ...
        Epreuve athletisme110mM = new Epreuve("Athletisme 110m haies masculin" , athletisme110m, "M", 2, 3.5, 2);
        Epreuve athletisme110mF = new Epreuve("Athletisme 110m haies féminin" , athletisme110m, "F", 2, 3.5, 2);
        ...
        Epreuve athletismeRelaisM = new Epreuve("Athletisme relais 400m masculin", athletismeRelais, "M", 1.5, 4, 2);
        Epreuve athletismeRelaisF = new Epreuve("Athletisme relais 400m féminin", athletismeRelais, "F", 1.5, 4, 2);
